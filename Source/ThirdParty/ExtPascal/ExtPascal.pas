...
procedure TExtSession.JSSleep(MiliSeconds : integer);
begin
...
procedure TExtSession.InitDefaultValues;
begin
  inherited;
{$IFDEF CacheFly}
...
function TExtSession.GetSequence : string;
begin
...
function TExtObject.RequestDownload(Method : TExtProcedure) : TExtFunction;
begin
...
function TExtObject.JSExpression(Method : TExtFunction) : integer;
begin
...
function TExtObject.JSString(Method : TExtFunction) : string;
begin
  Result := JSString('%s', [Method]);
end;

// Returns the JS command generated by a method
function TExtObject.JSMethod(Method : TExtFunction) : string;
begin
...
procedure TExtObject.Free(CallDestroyJS : boolean = false);
begin
