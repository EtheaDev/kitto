...
type
  ...
  // Procedural types for events TExtCalendarPanel
  TExtCalendarPanelOnDatechange = procedure(This : TExtCalendarPanel; StartDate : TDateTime; ViewStart : TDateTime; ViewEnd : TDateTime) of object;
  TExtCalendarPanelOnDayclick = procedure(This : TExtCalendarPanel; Dt : TDateTime; Allday : Boolean; El : TExtElement) of object;
  TExtCalendarPanelOnEventadd = procedure(This : TExtCalendarPanel; Rec : TExtCalendarEventRecord) of object;
  TExtCalendarPanelOnEventcancel = procedure(This : TExtCalendarPanel; Rec : TExtCalendarEventRecord) of object;
  TExtCalendarPanelOnEventclick = procedure(This : TExtCalendarPanel; Rec : TExtCalendarEventRecord; El : THTMLNode) of object;
  TExtCalendarPanelOnEventdelete = procedure(This : TExtCalendarPanel; Rec : TExtCalendarEventRecord) of object;
  TExtCalendarPanelOnEventmove = procedure(This : TExtCalendarPanel; Rec : TExtCalendarEventRecord) of object;
  TExtCalendarPanelOnEventout = procedure(This : TExtCalendarPanel; Rec : TExtCalendarEventRecord; El : THTMLNode) of object;
  TExtCalendarPanelOnEventover = procedure(This : TExtCalendarPanel; Rec : TExtCalendarEventRecord; El : THTMLNode) of object;
  TExtCalendarPanelOnEventresize = procedure(This : TExtCalendarPanel; Rec : TExtCalendarEventRecord) of object;
  TExtCalendarPanelOnEventsrendered = procedure(This : TExtCalendarPanel) of object;
  TExtCalendarPanelOnEventupdate = procedure(This : TExtCalendarPanel; Rec : TExtCalendarEventRecord) of object;
  TExtCalendarPanelOnInitdrag = procedure(This : TExtCalendarPanel) of object;
  TExtCalendarPanelOnRangeselect = procedure(This : TExtCalendarPanel; Dates : TExtObject; Callback : TExtFunction) of object;
  TExtCalendarPanelOnViewchange = procedure(This : TExtCalendarPanel; View : TExtCalendarView; Info : TExtObject) of object;
  ...
  private
    ...
    FWeekText : String;
    FActiveItem: Integer;
    FOnDatechange : TExtCalendarPanelOnDatechange;
    FOnDayclick : TExtCalendarPanelOnDayclick;
    FOnEventadd : TExtCalendarPanelOnEventadd;
    FOnEventcancel : TExtCalendarPanelOnEventcancel;
    FOnEventclick : TExtCalendarPanelOnEventclick;
    FOnEventdelete : TExtCalendarPanelOnEventdelete;
    FOnEventmove : TExtCalendarPanelOnEventmove;
    FOnEventout : TExtCalendarPanelOnEventout;
    FOnEventover : TExtCalendarPanelOnEventover;
    FOnEventresize : TExtCalendarPanelOnEventresize;
    FOnEventsrendered : TExtCalendarPanelOnEventsrendered;
    FOnEventupdate : TExtCalendarPanelOnEventupdate;
    FOnInitdrag : TExtCalendarPanelOnInitdrag;
    FOnRangeselect : TExtCalendarPanelOnRangeselect;
    FOnViewchange : TExtCalendarPanelOnViewchange;
    FCalendarStore: TExtDataStore;
    FEventStore: TExtDataStore;
    procedure SetDayText(Value : String);
    ...
    procedure SetFOnDatechange(Value : TExtCalendarPanelOnDatechange);
    procedure SetFOnDayclick(Value : TExtCalendarPanelOnDayclick);
    procedure SetFOnEventadd(Value : TExtCalendarPanelOnEventadd);
    procedure SetFOnEventcancel(Value : TExtCalendarPanelOnEventcancel);
    procedure SetFOnEventclick(Value : TExtCalendarPanelOnEventclick);
    procedure SetFOnEventdelete(Value : TExtCalendarPanelOnEventdelete);
    procedure SetFOnEventmove(Value : TExtCalendarPanelOnEventmove);
    procedure SetFOnEventout(Value : TExtCalendarPanelOnEventout);
    procedure SetFOnEventover(Value : TExtCalendarPanelOnEventover);
    procedure SetFOnEventresize(Value : TExtCalendarPanelOnEventresize);
    procedure SetFOnEventsrendered(Value : TExtCalendarPanelOnEventsrendered);
    procedure SetFOnEventupdate(Value : TExtCalendarPanelOnEventupdate);
    procedure SetFOnInitdrag(Value : TExtCalendarPanelOnInitdrag);
    procedure SetFOnRangeselect(Value : TExtCalendarPanelOnRangeselect);
    procedure SetFOnViewchange(Value : TExtCalendarPanelOnViewchange);
  ...
  public
    ...
    property OnDatechange : TExtCalendarPanelOnDatechange read FOnDatechange write SetFOnDatechange;
    property OnDayclick : TExtCalendarPanelOnDayclick read FOnDayclick write SetFOnDayclick;
    property OnEventadd : TExtCalendarPanelOnEventadd read FOnEventadd write SetFOnEventadd;
    property OnEventcancel : TExtCalendarPanelOnEventcancel read FOnEventcancel write SetFOnEventcancel;
    property OnEventclick : TExtCalendarPanelOnEventclick read FOnEventclick write SetFOnEventclick;
    property OnEventdelete : TExtCalendarPanelOnEventdelete read FOnEventdelete write SetFOnEventdelete;
    property OnEventmove : TExtCalendarPanelOnEventmove read FOnEventmove write SetFOnEventmove;
    property OnEventout : TExtCalendarPanelOnEventout read FOnEventout write SetFOnEventout;
    property OnEventover : TExtCalendarPanelOnEventover read FOnEventover write SetFOnEventover;
    property OnEventresize : TExtCalendarPanelOnEventresize read FOnEventresize write SetFOnEventresize;
    property OnEventsrendered : TExtCalendarPanelOnEventsrendered read FOnEventsrendered write SetFOnEventsrendered;
    property OnEventupdate : TExtCalendarPanelOnEventupdate read FOnEventupdate write SetFOnEventupdate;
    property OnInitdrag : TExtCalendarPanelOnInitdrag read FOnInitdrag write SetFOnInitdrag;
    property OnRangeselect : TExtCalendarPanelOnRangeselect read FOnRangeselect write SetFOnRangeselect;
    property OnViewchange : TExtCalendarPanelOnViewchange read FOnViewchange write SetFOnViewchange;
  end;
...
procedure TExtCalendarPanel.SetDayText(Value : String);
begin
  FDayText := Value;
  ExtSession.ResponseItems.SetConfigItem(Self, 'dayText', [Value]);
end;
...
procedure TExtCalendarPanel.SetFOnDayclick(Value : TExtCalendarPanelOnDayclick);
begin
...
procedure TExtCalendarPanel.SetFOnEventadd(Value : TExtCalendarPanelOnEventadd);
begin
...
procedure TExtCalendarPanel.SetFOnEventcancel(Value : TExtCalendarPanelOnEventcancel);
begin
...
procedure TExtCalendarPanel.SetFOnEventclick(Value : TExtCalendarPanelOnEventclick);
begin
  if Assigned(FOnEventclick) then
    JSCode(JSName+'.events ["eventclick"].listeners=[];');
  if Assigned(Value) then
...
procedure TExtCalendarPanel.SetFOnEventdelete(Value : TExtCalendarPanelOnEventdelete);
begin
  if Assigned(FOnEventdelete) then
    JSCode(JSName+'.events ["eventdelete"].listeners=[];');
  if Assigned(Value) then
...
procedure TExtCalendarPanel.SetFOnEventmove(Value : TExtCalendarPanelOnEventmove);
begin
  if Assigned(FOnEventmove) then
    JSCode(JSName+'.events ["eventmove"].listeners=[];');
  if Assigned(Value) then
...
procedure TExtCalendarPanel.SetFOnEventout(Value : TExtCalendarPanelOnEventout);
begin
  if Assigned(FOnEventout) then
    JSCode(JSName+'.events ["eventout"].listeners=[];');
  if Assigned(Value) then
...
procedure TExtCalendarPanel.SetFOnEventover(Value : TExtCalendarPanelOnEventover);
begin
  if Assigned(FOnEventover) then
    JSCode(JSName+'.events ["eventover"].listeners=[];');
  if Assigned(Value) then
...
procedure TExtCalendarPanel.SetFOnEventresize(Value : TExtCalendarPanelOnEventresize);
begin
...
procedure TExtCalendarPanel.SetFOnEventsrendered(Value : TExtCalendarPanelOnEventsrendered);
begin
  if Assigned(FOnEventsrendered) then
    JSCode(JSName+'.events ["eventsrendered"].listeners=[];');
  if Assigned(Value) then
...
procedure TExtCalendarPanel.SetFOnEventupdate(Value : TExtCalendarPanelOnEventupdate);
begin
...
procedure TExtCalendarPanel.SetFOnInitdrag(Value : TExtCalendarPanelOnInitdrag);
begin
  if Assigned(FOnInitdrag) then
    JSCode(JSName+'.events ["initdrag"].listeners=[];');
  if Assigned(Value) then
...
procedure TExtCalendarPanel.SetFOnRangeselect(Value : TExtCalendarPanelOnRangeselect);
begin
  if Assigned(FOnRangeselect) then
    JSCode(JSName+'.events ["rangeselect"].listeners=[];');
  if Assigned(Value) then
...
procedure TExtCalendarPanel.SetFOnViewchange(Value : TExtCalendarPanelOnViewchange);
begin
...
function TExtCalendarPanel.GetActiveView : TExtFunction;
begin
  JSCode(JSName + '.getActiveView();', 'TExtCalendarPanel');
  Result := Self;
end;

function TExtCalendarPanel.HideEditForm : TExtFunction;
begin
  JSCode(JSName + '.hideEditForm();', 'TExtCalendarPanel');
  Result := Self;
end;

function TExtCalendarPanel.SetStartDate(Dt : TDateTime) : TExtFunction;
begin
  JSCode(JSName + '.setStartDate(' + VarToJSON([Dt]) + ');', 'TExtCalendarPanel');
  Result := Self;
end;

function TExtCalendarPanel.ShowEditForm(RecordJS : TExtCalendarEventRecord) : TExtFunction;
begin
  JSCode(JSName + '.showEditForm(' + VarToJSON([RecordJS, false]) + ');', 'TExtCalendarPanel');
  Result := Self;
end;

procedure TExtCalendarPanel.HandleEvent(const AEvtName : string);
begin
  inherited;
  if (AEvtName = 'datechange') and Assigned(FOnDatechange) then
    FOnDatechange(TExtCalendarPanel(ParamAsObject('This')), ParamAsTDateTime('StartDate'), ParamAsTDateTime('ViewStart'), ParamAsTDateTime('ViewEnd'))
  else if (AEvtName = 'dayclick') and Assigned(FOnDayclick) then
    FOnDayclick(TExtCalendarPanel(ParamAsObject('This')), ParamAsTDateTime('Dt'), ParamAsBoolean('Allday'), TExtElement(ParamAsObject('El')))
  else if (AEvtName = 'eventadd') and Assigned(FOnEventadd) then
    FOnEventadd(TExtCalendarPanel(ParamAsObject('This')), TExtCalendarEventRecord(ParamAsObject('Rec')))
  else if (AEvtName = 'eventcancel') and Assigned(FOnEventcancel) then
    FOnEventcancel(TExtCalendarPanel(ParamAsObject('This')), TExtCalendarEventRecord(ParamAsObject('Rec')))
  else if (AEvtName = 'eventclick') and Assigned(FOnEventclick) then
    FOnEventclick(TExtCalendarPanel(ParamAsObject('This')), TExtCalendarEventRecord(ParamAsObject('Rec')), THTMLNode(ParamAsObject('El')))
  else if (AEvtName = 'eventdelete') and Assigned(FOnEventdelete) then
    FOnEventdelete(TExtCalendarPanel(ParamAsObject('This')), TExtCalendarEventRecord(ParamAsObject('Rec')))
  else if (AEvtName = 'eventmove') and Assigned(FOnEventmove) then
    FOnEventmove(TExtCalendarPanel(ParamAsObject('This')), TExtCalendarEventRecord(ParamAsObject('Rec')))
  else if (AEvtName = 'eventout') and Assigned(FOnEventout) then
    FOnEventout(TExtCalendarPanel(ParamAsObject('This')), TExtCalendarEventRecord(ParamAsObject('Rec')), THTMLNode(ParamAsObject('El')))
  else if (AEvtName = 'eventover') and Assigned(FOnEventover) then
    FOnEventover(TExtCalendarPanel(ParamAsObject('This')), TExtCalendarEventRecord(ParamAsObject('Rec')), THTMLNode(ParamAsObject('El')))
  else if (AEvtName = 'eventresize') and Assigned(FOnEventresize) then
    FOnEventresize(TExtCalendarPanel(ParamAsObject('This')), TExtCalendarEventRecord(ParamAsObject('Rec')))
  else if (AEvtName = 'eventsrendered') and Assigned(FOnEventsrendered) then
    FOnEventsrendered(TExtCalendarPanel(ParamAsObject('This')))
  else if (AEvtName = 'eventupdate') and Assigned(FOnEventupdate) then
    FOnEventupdate(TExtCalendarPanel(ParamAsObject('This')), TExtCalendarEventRecord(ParamAsObject('Rec')))
  else if (AEvtName = 'initdrag') and Assigned(FOnInitdrag) then
    FOnInitdrag(TExtCalendarPanel(ParamAsObject('This')))
  else if (AEvtName = 'rangeselect') and Assigned(FOnRangeselect) then
    FOnRangeselect(TExtCalendarPanel(ParamAsObject('This')), TExtObject(ParamAsObject('Dates')), TExtFunction(ParamAsObject('Callback')))
  else if (AEvtName = 'viewchange') and Assigned(FOnViewchange) then
    FOnViewchange(TExtCalendarPanel(ParamAsObject('This')), TExtCalendarView(ParamAsObject('View')), TExtObject(ParamAsObject('Info')));
end;
